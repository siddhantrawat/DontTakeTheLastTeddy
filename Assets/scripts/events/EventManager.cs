...
public static class EventManager
{
    ...
    static List<DontTakeTheLastTeddy> gameStartInvokers =
        new List<DontTakeTheLastTeddy>();
    static List<UnityAction> gameStartListeners =
    ...
    /// </summary>
    /// <param name="invoker">invoker</param>
    public static void AddGameStartInvoker(DontTakeTheLastTeddy invoker)
    {
        gameStartInvokers.Add(invoker);
        foreach (UnityAction listener in gameStartListeners)
        {
            invoker.AddGameStartListener(listener);
        }
    }
    ...
    public static void AddGameStartListener(UnityAction listener)
    {
        ...
        foreach (DontTakeTheLastTeddy invoker in gameStartInvokers)
        {
            invoker.AddGameStartListener(listener);
        }
    }
